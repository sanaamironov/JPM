...
from experiments.paths import results_dir, figures_dir
...
def main():
    ...
    out_png = figures_dir() / "influence_matrix.png"
    out_csv = results_dir() / "influence_matrix.csv"

    plot_influence_heatmap(influence, out_png)
    save_influence_csv(influence, out_csv)

    print("\nSaved:")
    print("  - influence heatmap:", str(out_png))
